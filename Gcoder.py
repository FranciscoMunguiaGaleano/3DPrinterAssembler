...
#These actions that can be used from the status bar        
        ...
        openAction = QtGui.QAction(QtGui.QIcon('imgs\OPEN.png'), 'Open ', self)
        openAction.setShortcut('Ctrl+O')
        openAction.setStatusTip('Open a file')
        openAction.triggered.connect(self.showopen)

        saveAction = QtGui.QAction(QtGui.QIcon('imgs\guardar.png'), 'Save ', self)
        saveAction.setShortcut('Ctrl+S')
        saveAction.setStatusTip('Save a file')
        saveAction.triggered.connect(self.save)

        saveasAction = QtGui.QAction(QtGui.QIcon('imgs\guardar_como.png'), 'Save as', self)
...
####################################################################
        undoAction = QtGui.QAction(QtGui.QIcon('imgs\undo.png'), 'Undo', self)
        undoAction.setShortcut('Ctrl+Z')
        undoAction.setStatusTip('Undo')
        undoAction.triggered.connect(self.doundo)
        redoAction = QtGui.QAction(QtGui.QIcon('imgs\redo.png'), 'Redo', self)
        redoAction.setShortcut('Ctrl+Shift+Z')
        redoAction.setStatusTip('Redo')
        redoAction.triggered.connect(self.doredo)
        
        copyAction = QtGui.QAction(QtGui.QIcon('imgs\copy.png'), 'Copy', self)
        copyAction.setShortcut('Ctrl+C')
        copyAction.setStatusTip('Copy')
        copyAction.triggered.connect(self.docopy)
        cutAction = QtGui.QAction(QtGui.QIcon('imgs\cut.png'), 'Cut', self)
        cutAction.setShortcut('Ctrl+X')
        cutAction.setStatusTip('Cut')
        cutAction.triggered.connect(self.docut)
        pasteAction = QtGui.QAction(QtGui.QIcon('imgs\paste.png'), 'Paste', self)
        pasteAction.setShortcut('Ctrl+V')
        pasteAction.setStatusTip('Paste')
        pasteAction.triggered.connect(self.dopaste)
######################################################################
        playAction = QtGui.QAction(QtGui.QIcon('imgs\play.png'), 'Run ', self)
        playAction.setShortcut('Ctrl+R')
        playAction.setStatusTip('Run the program')
        playAction.triggered.connect(self.play)
        pauseAction = QtGui.QAction(QtGui.QIcon('imgs\pause.png'), 'Pause', self)
        pauseAction.setShortcut('Ctrl+P')
        pauseAction.setStatusTip('Pause the program')
        pauseAction.triggered.connect(self.pause)
        fowardAction = QtGui.QAction(QtGui.QIcon('imgs\foward.png'), 'Foward', self)
        ...
        stopAction = QtGui.QAction(QtGui.QIcon('imgs\stop.png'), 'Stop', self)
